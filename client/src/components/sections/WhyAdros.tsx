...
export default function WhyAdros() {
  ...
  return (
    <section id="why-adros" className="py-20 bg-background" data-animate="section">
      <div className="container max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16" data-animate-stagger>
          {features.map((feature, i) => {
            const Icon = feature.icon;
            return (
              <div key={i} className="bg-secondary/30 rounded-xl p-8 border border-border hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300" data-animate="item">
        ...
        <div className="bg-gradient-to-r from-purple-600/10 to-blue-600/10 border border-primary/20 rounded-xl p-8">
