      ...
      <div className="container max-w-4xl">
        ...
        <div className="space-y-8">
          <p className="text-lg text-foreground leading-relaxed">
            AI isn't "coming to marketing." It's already here — and it's creating a canyon between businesses that use it and businesses that don't.
          </p>
          ...
          <p className="text-lg font-semibold text-center text-primary">
            The question isn't whether AI will run your ads. It's whether you'll be ahead — or playing catch-up.
          </p>
        </div>
      </div>
    </section>
